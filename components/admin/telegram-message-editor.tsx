    ...
    <div className="grid gap-6 xl:grid-cols-[minmax(0,1.2fr)_380px]">
      <section className="rounded-[24px] border border-white/10 bg-[linear-gradient(180deg,rgba(26,18,16,0.96),rgba(13,9,8,0.98))] p-6 shadow-[0_24px_80px_rgba(0,0,0,0.35)]">
        ...
        <p className="mt-3 text-sm leading-6 text-neutral-400">
          Total ada 10 tombol opsional. Setiap 2 tombol membentuk 1 baris. Jika
          hanya satu tombol aktif dalam satu baris, preview akan menampilkannya
          penuh seperti pola BoxOffice.
        </p>
